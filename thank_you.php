...
width: 60%;
	...
	.bg-emt a {
padding: 10px;
	background: black;border: none;color: aliceblue;border-radius: 4px;}
.flake path{
  fill:#fff;
}
...
<div class="background">
  ...
  <h2>Your order has been placed successfully</h2>
			...
			<div class="bg-emt" style="display:flex; justify-content:center;">
		<img src="img/email.png" style="width:30%; height:30%;">
			<h3>An email receipt including the details about your order has been sent to your email address provided. Please keep it for your records.</h3>
					</div>
			...
			<h3>You can visit My Account page at any time to check the status of your order.</h3>
				<img src="img/printer.png" style="width:30%; height:30%">
					</div>
			

	<div class="bg-emt">
	<a href="index.php"><i class="fa fa-arrow-left" aria-hidden="true"></i> Continue to Homepage</a>
</div>
	</div>
	</div>		
