					  ...
					  <table class="table">
							<thead>
								<tr>
									...
									<th class="product-name"><span class="nobr">Receiver Name</span></th>
									
									<th class="product-price"><span class="nobr"> Address </span></th>
										<th class="product-price"><span class="nobr"> Phone </span></th>
									
									<th class="product-name"><span class="nobr">LandMark</span></th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="product-name"><?php echo $row['receiver_name']?></td>
									...
									<td class="product-name"><?php echo $row['landmark']?></td>
