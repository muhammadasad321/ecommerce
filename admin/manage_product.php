...
if(isset($_POST['submit'])){
 ...
 $update_sql="update product set  shop_id='$shop_id',shop='$shop',shop_address='$shop_address', categories_id='$categories_id',name='$name',image='$image',second='$second',third='$third',video='$video',short_desc='$short_desc',description='$description',meta_title='$meta_title',meta_desc='$meta_desc',meta_keyword='$meta_keyword',best_seller='$best_seller',feature_product='$feature_product',best_deal='$best_deal',sub_categories_id='$sub_categories_id' where id='$id'";
				}}}else{
				 $update_sql="update product set  shop_id='$shop_id',shop='$shop',shop_address='$shop_address', categories_id='$categories_id',name='$name'video='$video',short_desc='$short_desc',description='$description',meta_title='$meta_title',meta_desc='$meta_desc',meta_keyword='$meta_keyword',best_seller='$best_seller',feature_product='$feature_product',best_deal='$best_deal',sub_categories_id='$sub_categories_id' where id='$id'";
			}
			if(isset($update_sql)) {
			...
			mysqli_query($con,"insert into product(shop_id,shop,shop_address,categories_id,name,image,second,third,video,short_desc,description,meta_title,meta_desc,meta_keyword,status,best_seller,feature_product,best_deal,sub_categories_id,added_by) values('$shop_id','$shop','$shop_address','$categories_id','$name','$image','$second','$third','$video','$short_desc','$description','$meta_title','$meta_desc','$meta_keyword',1,'$best_seller','$feature_product','$best_deal','$sub_categories_id','".$_SESSION['ADMIN_ID']."')");
										...
										<?php
											...
											while($row=mysqli_fetch_assoc($res)){
												if($list['color_id']==$row['id']){
													echo "<option value=".$row['id']." id='color-style' style='background:".$row['color']." none repeat scroll 0 0;color:black; border-radius:50%;padding:7px;' selected>".$row['color']."</option>";
												}else{
													echo "<option value=".$row['id']." id='color-style' style='background:".$row['color']." none repeat scroll 0 0;color:black; border-radius:50%;padding:7px;' >".$row['color']."</option>";	
												}
											}
											?>
										</select>
